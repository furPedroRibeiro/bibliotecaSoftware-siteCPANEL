  ...
  <header class="header">
    ...
    <div class="main">
        <div class="parte1">
            <div class="formCad">
                <h1>Cadastrar gênero</h1>
                    <form action="" method="post" class="form" name="generox">
                        <input type="text" name="nomeGen"  id="nomeGen" placeholder="Digite o gênero: "/>
                        <button class="buttonDefault" name="genero">Enviar</button>
                        <?php
                            include('biblioteca.php');
                            if(isset($_POST['nomeGen'])){
                                CadastrarGenero($_POST['nomeGen']);
                            } 
                        ?>
                    </form>
            ...
            <div class="pesquisa">
                <h1>Pesquisar gênero</h1>
                <form method="post" class="form" name="pesquisaForm">
                    <input type="text" name="pesquisa"  id="pesquisa" placeholder="Pesquisar gênero: "/>
                    <button class="buttonDefault" name="pesquisaBtn">Pesquisar</button>
                    <?php
                            if(isset($_POST['pesquisa'])){
                                PesquisarGenero($_POST['pesquisa']);
                            } 
                        ?>
                </form>
                <a href="pageAdm.php"><button class="buttonDefault">Voltar</button></a>
